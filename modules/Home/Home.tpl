	...
	<tr>
		...
		<td valign='top' width='{$data.width}'>
			<ul class='Bullet' id='col_{$activePage}_{$colNum}'>
				<li id='page_{$activePage}_hidden{$hiddenCounter}b' style='height: 5px' class='Bullet'>&nbsp;&nbsp;&nbsp;</li>
				...
				{/foreach}
				<li id='page_{$activePage}_hidden{$hiddenCounter}' style='height: 5px' class='Bullet'>&nbsp;&nbsp;&nbsp;</li>
			</ul>
		</td>
		{counter}
		{/foreach}
