{* /** * * SugarCRM Community Edition is a customer relationship management program developed by * SugarCRM, Inc. Copyright (C) 2004-2013 SugarCRM Inc. * * SuiteCRM is an extension to SugarCRM Community Edition developed by SalesAgility
Ltd. * Copyright (C) 2011 - 2018 SalesAgility Ltd. * * This program is free software; you can redistribute it and/or modify it under * the terms of the GNU Affero General Public License version 3 as published by the * Free Software
Foundation with the addition of the following permission added * to Section 15 as permitted in Section 7(a): FOR ANY PART OF THE COVERED WORK * IN WHICH THE COPYRIGHT IS OWNED BY SUGARCRM, SUGARCRM DISCLAIMS THE WARRANTY * OF NON
INFRINGEMENT OF THIRD PARTY RIGHTS. * * This program is distributed in the hope that it will be useful, but WITHOUT * ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS * FOR A PARTICULAR PURPOSE. See the GNU
Affero General Public License for more * details. * * You should have received a copy of the GNU Affero General Public License along with * this program; if not, see http://www.gnu.org/licenses or write to the Free * Software Foundation,
Inc., 51 Franklin Street, Fifth Floor, Boston, MA * 02110-1301 USA. * * You can contact SugarCRM, Inc. headquarters at 10050 North Wolfe Road, * SW2-130, Cupertino, CA 95014, USA. or at email address contact@sugarcrm.com. * * The
interactive user interfaces in modified source and object code versions * of this program must display Appropriate Legal Notices, as required under * Section 5 of the GNU Affero General Public License version 3. * * In accordance with
Section 7(b) of the GNU Affero General Public License version 3, * these Appropriate Legal Notices must retain the display of the "Powered by * SugarCRM" logo and "Supercharged by SuiteCRM" logo. If the display of the logos is not *
reasonably feasible for technical reasons, the Appropriate Legal Notices must * display the words "Powered by SugarCRM" and "Supercharged by SuiteCRM". */ *}
<form name="ConfigureSettings" enctype="multipart/form-data" method="POST" action="index.php" onSubmit="return (add_checks(document.ConfigureSettings) && check_form('ConfigureSettings'));">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="interfases-ui" data-ui="user">
                        ...
                        <h3>{$MOD.DEFAULT_SYSTEM_SETTINGS}</h3>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view table-panel-edit userinterface">
        <tr class="main-title-table">
            <th align="left" scope="row" colspan="4" class=""><h4>{$MOD.DEFAULT_SYSTEM_SETTINGS}</h4></th>
        </tr>
        ...
        <tr>
            ...
            <td>
                {if !empty($config.lock_homepage)} {assign var='lock_homepage_checked' value='CHECKED'} {else} {assign var='lock_homepage_checked' value=''} {/if}
            ...
            <td>
                {if !empty($config.lock_subpanels)} {assign var='lock_subpanels_checked' value='CHECKED'} {else} {assign var='lock_subpanels_checked' value=''} {/if}
        ...
        <tr>
            ...
            {if !empty($config.use_real_names)} {assign var='use_real_names' value='CHECKED'} {else} {assign var='use_real_names' value=''} {/if}
            <td>
        ...
        <tr>
            ...
            {if !empty($config.calculate_response_time )} {assign var='calculate_response_time_checked' value='CHECKED'} {else} {assign var='calculate_response_time_checked' value=''} {/if}
            ...
            {if !empty($config.default_module_favicon)} {assign var='default_module_favicon' value='CHECKED'} {else} {assign var='default_module_favicon' value=''} {/if}
            <td>
        ...
        <tr>
            ...
            {if !empty($config.disable_convert_lead)} {assign var='disable_convert_lead' value='CHECKED'} {else} {assign var='disable_convert_lead' value=''} {/if}
            <td>
        ...
        <tr>
            ...
            {if isset($config.enable_action_menu) && $config.enable_action_menu != "true" } {assign var='enable_action_menu' value=''} {else} {assign var='enable_action_menu' value='CHECKED'} {/if}
            <td>
        ...
        <tr>
            ...
            {if isset($config.enable_line_editing_list) && $config.enable_line_editing_list != "true" } {assign var='enable_line_editing_list' value=''} {else} {assign var='enable_line_editing_list' value='CHECKED'} {/if}
            <td>
            ...
            {if isset($config.enable_line_editing_detail) && $config.enable_line_editing_detail != "true" } {assign var='enable_line_editing_detail' value=''} {else} {assign var='enable_line_editing_detail' value='CHECKED'} {/if}
            <td>
        ...
        <tr>
            ...
            {if (isset($config.hide_subpanels) && $config.hide_subpanels != "true") || !isset($config.hide_subpanels)} {assign var='hide_subpanels' value=''} {else} {assign var='hide_subpanels' value='CHECKED'} {/if}
            <td>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view proxy">
        ...
        <tr>
            ...
            <td width="75%" align="left" valign="middle" colspan="3">
                <input type="hidden" name="proxy_on" value="0" /><input name="proxy_on" id="proxy_on" value="1" class="checkbox" tabindex="1" type="checkbox" {$proxy_on_checked} onclick='toggleDisplay_2("proxy_config_display")' />
            </td>
        </tr>
        <tr>
            <td colspan="4">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left" valign="middle">
                                ...
                                <input id="proxy_auth" name="proxy_auth" value="1" class="checkbox" tabindex="1" type="checkbox" {$proxy_auth_checked} onclick='toggleDisplay_2("proxy_auth_display")' />
                            </td>
                        </tr>
                    </table>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view avanced">
        ...
        <tr>
            ...
            {if !empty($config.verify_client_ip)} {assign var='verify_client_ip_checked' value='CHECKED'} {else} {assign var='verify_client_ip_checked' value=''} {/if}
            ...
            {if !empty($config.log_memory_usage)} {assign var='log_memory_usage_checked' value='CHECKED'} {else} {assign var='log_memory_usage_checked' value=''} {/if}
        ...
        <tr>
            ...
            {if !empty($config.dump_slow_queries)} {assign var='dump_slow_queries_checked' value='CHECKED'} {else} {assign var='dump_slow_queries_checked' value=''} {/if}
        ...
        <tr>
            ...
            {if !empty($config.stack_trace_errors)} {assign var='stack_trace_errors_checked' value='CHECKED'} {else} {assign var='stack_trace_errors_checked' value=''} {/if}
        ...
        <tr>
            ...
            {if !empty($config.developerMode)} {assign var='developerModeChecked' value='CHECKED'} {else} {assign var='developerModeChecked' value=''} {/if}
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view visibled">
        ...
        <tr>
            ...
            <td>
                <select name="logger_file_suffix" selected="{$config.logger.file.suffix}">
                    {$filename_suffix}
                </select>
            </td>
        </tr>
    ...
    <div style="padding-top: 2px;">
        <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" class="button primary m-t-10 btn-principal" type="submit" name="save" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " class="button primary" />
        &nbsp;<!--<input title="{$MOD.LBL_SAVE_BUTTON_TITLE}"  class="button"  type="submit" name="restore" value="  {$MOD.LBL_RESTORE_BUTTON_LABEL} " />-->
        &nbsp;<input title="{$MOD.LBL_CANCEL_BUTTON_TITLE}" onclick="document.location.href='index.php?module=Administration&action=index'" class="button  m-t-10 btn-principal" type="button" name="cancel" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  " />
    </div>
    {$JAVASCRIPT}
</form>
