		...
		<div class="main">
				<ul id="og-grid" class="og-grid">
					...
					<li>
						...
						<a href="#" data-largesrc="https://image.flaticon.com/icons/svg/1246/1246351.svg" data-title="Veggies sunt bona vobis" data-description="Komatsuna prairie turnip wattle seed artichoke mustard horseradish taro rutabaga ricebean carrot black-eyed pea turnip greens beetroot yarrow watercress kombu.">
							<img src="https://image.flaticon.com/icons/svg/1246/1246351.svg" alt="img02"/>
							<div class="main-title-table">
								<h4>{$MOD.DEFAULT_SYSTEM_SETTINGS}</h4>
							</div>
