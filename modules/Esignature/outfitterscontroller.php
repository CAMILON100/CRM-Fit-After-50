...
if ($_REQUEST['method'] == 'validate') {
	EsignatureLicense::validate();
} else if ($_REQUEST['method'] == 'change') {
	EsignatureLicense::change();
} else if ($_REQUEST['method'] == 'add') {
	EsignatureLicense::add();
	...
	$validate_license = EsignatureLicense::isValid($currentModule, $user_id, true);
	...
	if ($validate_license !== true) {
		...
		/*
			          $validated = GoogleLoginLicense::doValidate($currentModule);
