...
function insertProductLine(tableid, groupid) {
  ...
  f.innerHTML += "<input type='text' tabindex='116' name='product_vat[" + prodln + "]' id='product_vat" + prodln + "' onchange='calculateLine(" + prodln + ",\"product_\");' class='product_vat_amt_select' style='width:100px'>";
...
function insertServiceLine(tableid, groupid) {
  ...
  a2.innerHTML += "<input type='text' tabindex='116' name='service_discount[" + servln + "]' id='service_discount" + servln + "' onchange='calculateLine(" + servln + ",\"service_\");'  style='width:100px'>";
  ...
  c.innerHTML = "<input type='text' name='service_vat_amt[" + servln + "]' id='service_vat_amt" + servln + "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='service_vat_text'>";
   c.innerHTML += "<input type='text' tabindex='116' name='service_vat[" + servln + "]' id='service_vat" + servln + "' onchange='calculateLine(" + servln + ",\"service_\");'  style='width:100px'>";
  if (typeof currencyFields !== 'undefined'){
