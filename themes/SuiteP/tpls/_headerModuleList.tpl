                                        ...
                                        {else}
                                            <li class="actionmenulinks" role="presentation">
                                                <a href="{$item.URL}" data-action-name="{$item.MODULE_NAME}">
                                                    ...
                                                    <div class="actionmenulink"><span class="suitepicon suitepicon-action-{$item.MODULE_NAME|lower|replace:'_':'-'}"></span> {$item.LABEL}</div>
                                                </a>
                                            </li>
                                        {/if}
                                    {/foreach}
            ...
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        {$APP.LBL_CREATE_BUTTON_LABEL}<span class="glyphicon glyphicon-plus" style="padding-left:5px"></span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                ...
                <li id="globalLinks" class="dropdown nav navbar-nav globalLinks-mobile">
                    ...
                    <ul class="dropdown-menu user-dropdown user-menu" role="menu" aria-labelledby="dropdownMenu2">
                        ...
                        <li role="presentation">
                            <a href='index.php?module=Employees&action=index&record={$CURRENT_USER_ID}'>
                               Employees
                            </a>
                        </li>
                        <li role="presentation">
                        ...
                        <li role="presentation">
                            <a href='index.php?module=Home&action=About&record={$CURRENT_USER_ID}'>
                                About
                            </a>
                        </li>
                ...
                <li id="globalLinks" class="dropdown nav navbar-nav globalLinks-mobile">
                    ...
                    <ul class="dropdown-menu user-dropdown user-menu" role="menu" aria-labelledby="dropdownMenu2">
                        <li role="presentation">
                         ...
                         <li role="presentation">
                            <a href='index.php?module=Configurator&action=EditView&record={$CURRENT_USER_ID}'>
                                Settings
                            </a>
                        </li>
                        <li role="presentation">
