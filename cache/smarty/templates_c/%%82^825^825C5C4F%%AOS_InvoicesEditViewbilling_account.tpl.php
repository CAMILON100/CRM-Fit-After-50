<?php /* Smarty version 2.6.31, created on 2020-09-14 04:03:17
         compiled from cache/include/InlineEditing/AOS_InvoicesEditViewbilling_account.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/include/InlineEditing/AOS_InvoicesEditViewbilling_account.tpl', 7, false),)), $this); ?>

<input type="text" name="<?php echo $this->_tpl_vars['fields']['billing_account']['name']; ?>
" class="sqsEnabled" tabindex="1" id="<?php echo $this->_tpl_vars['fields']['billing_account']['name']; ?>
...
"<?php echo ',"name":'; ?>
"<?php echo $this->_tpl_vars['fields']['billing_account']['name']; ?>
"<?php echo '}}'; ?>
, 
	"single", 
	true
