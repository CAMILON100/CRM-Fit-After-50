...
<select name="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['type_contact_c']['value'] ) && $this->_tpl_vars['fields']['type_contact_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['type_contact_c']['options'],'selected' => $this->_tpl_vars['fields']['type_contact_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['type_contact_c']['options'],'selected' => $this->_tpl_vars['fields']['type_contact_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['type_contact_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['type_contact_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
');
...
<?php echo '\' );
addToValidate(\'EditView\', \'type_contact_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE_CONTACT','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
