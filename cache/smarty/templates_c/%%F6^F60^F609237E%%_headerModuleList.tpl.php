<?php /* Smarty version 2.6.31, created on 2020-10-02 02:56:07
...
<a class="navbar-brand" href="index.php?module=Home&action=index"><img src="custom/themes/default/images/company_logo.png" alt="Logo" width="55px" height="55px" style="margin-right:10px; margin-left:15px; margin-top:2px"/></a>
...
">
                                                    ...
                                                    <div class="actionmenulink"><span class="suitepicon suitepicon-action-<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['MODULE_NAME'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('replace', true, $_tmp, '_', '-') : smarty_modifier_replace($_tmp, '_', '-')); ?>
...
<span class="glyphicon glyphicon-plus" style="padding-left:5px"></span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
...
'>
                        ...
                        <li role="presentation">
                            <a href='index.php?module=Employees&action=index&record=<?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
'>
                               Employees
                            </a>
                        </li>
                        ...
                        <li role="presentation">
                            <a href='index.php?module=Home&action=About&record=<?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
'>
                                About
                            </a>
                        </li>
...
'>
                         ...
                         <li role="presentation">
                            <a href='index.php?module=Configurator&action=EditView&record=<?php echo $this->_tpl_vars['CURRENT_USER_ID']; ?>
'>
                                Settings
                            </a>
                        </li>
...
<div id='sidebar_container' class="container-fluid sidebar_container">
        ...
        <!--<a id="buttontoggle" class="buttontoggle"><i class="fas fa-bars"></i></a>-->
