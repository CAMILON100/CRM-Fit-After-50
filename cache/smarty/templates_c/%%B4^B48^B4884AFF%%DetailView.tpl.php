<?php /* Smarty version 2.6.31, created on 2020-09-08 14:44:11
         compiled from cache/themes/SuiteP/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 47, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 56, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 146, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 309, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 461, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 139, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 570, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 570, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 570, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 581, false),)), $this); ?>
...
<a type="button" class="button" onclick="$(document).openComposeViewModal(this);" data-module="Contacts" data-record-id="<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
" data-module-name="<?php echo $this->_tpl_vars['fields']['full_name']['value']; ?>
" data-email-address style="padding-top:10px"><?php echo $this->_tpl_vars['MOD']['LBL_SEND_EMAIL']; ?>
</a>
<a type="button" class="button" onClick="window.open(`https://api.whatsapp.com/send?phone=<?php echo $this->_tpl_vars['fields']['phone_mobile']['value']; ?>
`, `width=600,height=600`);" style="padding-top:10px"><?php echo $this->_tpl_vars['MOD']['LBL_SEND_WHATSAPP']; ?>
</a>
...
<li><a type="button" class="button" onclick="$(document).openComposeViewModal(this);" data-module="Contacts" data-record-id="<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
" data-module-name="<?php echo $this->_tpl_vars['fields']['full_name']['value']; ?>
" data-email-address style="padding-top:10px"><?php echo $this->_tpl_vars['MOD']['LBL_SEND_EMAIL']; ?>
</a></li>
<li><a type="button" class="button" onClick="window.open(`https://api.whatsapp.com/send?phone=<?php echo $this->_tpl_vars['fields']['phone_mobile']['value']; ?>
`, `width=600,height=600`);" style="padding-top:10px"><?php echo $this->_tpl_vars['MOD']['LBL_SEND_WHATSAPP']; ?>
</a></li>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="image" field="photo" colspan='3'>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE_CONTACT','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="enum" field="type_contact_c" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['type_contact_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['type_contact_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['type_contact_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['type_contact_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['type_contact_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['type_contact_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['type_contact_c']['options'][$this->_tpl_vars['fields']['type_contact_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="first_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="last_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit phone" type="phone" field="phone_work" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit phone" type="phone" field="phone_mobile" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="title" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="department" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="relate" field="account_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit phone" type="phone" field="phone_fax" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field" type="varchar" field="email1" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="primary_address_street" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="varchar" field="alt_address_street" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="relate" field="assigned_user_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="enum" field="lead_source" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="relate" field="report_to_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field inlineEdit" type="relate" field="campaign_name" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field" type="datetime" field="date_entered" colspan='3'>
...
<div class="col-xs-12 col-sm-12 detail-view-field" type="datetime" field="date_modified" colspan='3'>
