...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_USER_SIGNATURE' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{counter name="panelFieldCount"  print=false}
<input tabindex="0"  name="user_signature" id="user_signature" type="hidden" value="{$fields.user_signature.value}"><a id="bvbutton" style="text-decoration:none;" onclick="openSignaturePad();">Add signature</a><span id="signaturePreview"></span>
</div>
...
addToValidate('EditView', 'user_signature', 'varchar', false,'{/literal}{sugar_translate label='LBL_USER_SIGNATURE' module='Users' for_js=true}{literal}' );
