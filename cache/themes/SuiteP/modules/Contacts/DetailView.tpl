...
<a type="button" class="button" onclick="$(document).openComposeViewModal(this);" data-module="Contacts" data-record-id="{$fields.id.value}" data-module-name="{$fields.full_name.value}" data-email-address style="padding-top:10px">{$MOD.LBL_SEND_EMAIL}</a>
<a type="button" class="button" onClick="window.open(`https://api.whatsapp.com/send?phone={$fields.phone_mobile.value}`, `width=600,height=600`);" style="padding-top:10px">{$MOD.LBL_SEND_WHATSAPP}</a>
...
<li><a type="button" class="button" onclick="$(document).openComposeViewModal(this);" data-module="Contacts" data-record-id="{$fields.id.value}" data-module-name="{$fields.full_name.value}" data-email-address style="padding-top:10px">{$MOD.LBL_SEND_EMAIL}</a></li>
<li><a type="button" class="button" onClick="window.open(`https://api.whatsapp.com/send?phone={$fields.phone_mobile.value}`, `width=600,height=600`);" style="padding-top:10px">{$MOD.LBL_SEND_WHATSAPP}</a></li>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TYPE_CONTACT' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.type_contact_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.type_contact_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.type_contact_c.name}" value="{ $fields.type_contact_c.options }">
{ $fields.type_contact_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.type_contact_c.name}" value="{ $fields.type_contact_c.value }">
{ $fields.type_contact_c.options[$fields.type_contact_c.value]}
{/if}
{/if}
