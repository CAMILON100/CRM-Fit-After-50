...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_source_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_contact_c_advanced'>{sugar_translate label='LBL_TYPE_CONTACT' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='type_contact_c_advanced' name='type_contact_c_advanced[]' options=$fields.type_contact_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_contact_c_advanced.value}
                            </div>
        </div>
    </div>
