...
//redirect to license validation page - CHANGE NAME BELOW - To your module name
	...
	if (preg_match("/^6.*/", $sugar_version)) {
		echo "
            <script>
            document.location = 'index.php?module=Esignature&action=license_esignature';
            </script>"
		;
	} else {
		echo "
            ...
            window.parent.SUGAR.App.sync({callback: function(){
                app.router.navigate('#bwc/index.php?module=Esignature&action=license_esignature', {trigger:true});
            }});
            </script>"
		;
	}
