...
class ViewLicense_Esignature extends SugarView {

	protected function _getModuleTitleParams($browserTitle = false) {
		global $mod_strings;

		return array(
			"<a href='index.php?module=Administration&action=license_esignature'>" . translate('LBL_MODULE_NAME', 'Administration') . "</a>",
			translate('LBL_ESIGNATURE_LICENSEADDON', 'Administration') . ': ' . translate('LBL_ESIGNATURE_LICENSEADDON_DESCRIPTION', 'Administration'),
		);
	}
	...
	public function display() {
		...
		$license_strings = ViewLicense_Esignature::loadLicenseStrings();
		...
		if (isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
			...
			if (!empty($trimmed_last)) {
				...
				require_once 'modules/' . $currentModule . '/license/EsignatureLicense.php';

				$validated = EsignatureLicense::doValidate($currentModule);
		...
		$this->ss->display('modules/' . $currentModule . '/license/tpls/license_esignature.tpl');
	}
