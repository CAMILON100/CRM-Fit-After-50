...
',
  ...
  'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of : ',
  'HDR_LOGIN_PANEL' => 'Please enter your  Login credentials.',
  'HEARTBEAT_MESSAGE' => '<BR>The  Updates mechanism allows your server to check to see if an update for your version of  is available.',
  ...
  'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable',
  ...
  'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the  application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
  'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your  application files in a .zip file, enter the following information:',
  'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
  'LBL_BACKUPS_TITLE' => 'Backups',
  'LBL_BACKUPS' => 'Backup  files',
  'LBL_BUG_TITLE' => 'Bugs',
  ...
  'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Server.
  ...
  'LBL_DIAGNOSTIC_CUSTOMDIR' => ' Custom directory',
  ...
  'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting .log',
  ...
  'LBL_DIAGNOSTIC_SUITELOG' => ' Log File',
  ...
  'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the  Password Management feature settings will apply.',
  ...
  'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=',
  'LBL_LDAP_USER_DN_DESC' => 'Example: ou=people,dc=example,dc=com',
  'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist, one will be created in .',
  ...
  'LBL_MODULE_LOADER' => 'Add or remove  modules, themes, language packs and other extensions',
  ...
  'LBL_RETURN' => 'Return',
  'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
  ...
  'LBL_SUITE_UPDATE_TITLE' => 'Updates',
  ...
  'LBL_UPDATE_TITLE' => 'Updates',
  'LBL_UPGRADE_TITLE' => 'Repair',
  'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
  'LBL_UPGRADE_WIZARD' => 'Upload and install upgrades',
  'LBL_UPGRADE' => 'Check and repair',
  ...
  'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users.',
...
',
  ...
  'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality.',
  ...
  'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, Dashlets etc.',
  ...
  'LBL_QR_CBOX_CLEARDASHLET' => 'Clear  Dashlet Cache Data',
  ...
  'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear  Feed Cache',
  'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing  Feed Cache...done',
...
',
  ...
  'ML_RELAX_LOCAL' => 'If you are running  locally, you can relax your Module Loader restrictions to allow the package to be installed.',
  'ML_SUITE_KB' => ' Knowledge Base',
  'ML_SUITE_DZ' => ' Developer Zone',
  'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
  'ML_OVERRIDE_CORE_FILES' => 'Overriding of core  files is not allowed ',
  ...
  'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the  Password Management feature settings will apply.',
  ...
  'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Elasticsearch requires an external server set up to work. Read the <a href="https://docs..com/admin/administration-panel/search/elasticsearch/">documentation</a> to learn how.',
  ...
  'LBL_GOOGLE_SIGN_IN_ADMIN' => 'Google Sign-In',
  'LBL_GOOGLE_SIGN_IN_ADMIN_DESCRIPTION' => 'Enable Google Sign-In',
  'LBL_GOOGLE_SIGN_IN_ADMIN_TITLE' => 'Google Sign-In Configuration',
  'GOOGLE_SIGN_IN_ADMIN_TITLE' => 'Google Sign-In',
  'GOOGLE_SIGN_IN_ADMIN_DESC' => 'Google Sign-In Configuration',
  'LBL_GOOGLE_SIGN_IN_ADMIN_CLIENT_ID' => 'Client ID',
  'LBL_GOOGLE_SIGN_IN_ADMIN_CLIENT_SECRET' => 'Client Secret',
  'LBL_GOOGLE_SIGN_IN_ADMIN_MANAGE' => 'Google Sign-In Configuration',
  'LBL_MANAGE_ESIGNATURE' => 'ESignature',
  'LBL_ESIGNATURE' => 'ESignature Settings',
  'ESIGNATURE_ENABLE' => 'Enable ESignature',
  'ESIGNATURE_KEY' => 'Esignature Key',
  'ESIGNATURE_MODULES' => 'Enable Modules',
  'LBL_ESIGNATURE_LICENSEADDON' => 'License Configuration',
  'LBL_ESIGNATURE_LICENSEADDON_DESCRIPTION' => 'Manage and configure the license for this add-on',
);